...
struct ABC_params
{
	/*
		...
		Attributes:
			cycles_limit: Number of cycles of the colony.
			employed_limit: Maximum number of cycles an employed bee can perform
			colony_size: Size of the colony.
			scout_percent: Percentage of scout bees in the total colony.
			onlooker_percent: Percentage of onlooker bees in the total colony.
			employed_percent: Percentage of employed bees in the total colony.
	*/
	...
	double onlooker_percent = 0.2;
	double employed_percent = 0.8;
};
